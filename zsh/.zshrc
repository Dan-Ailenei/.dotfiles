...
export PATH=$PATH:$HOME/bin:$HOME/.local/bin:$HOME/.local/scripts:$HOME/.npm/packages/bin
export EDITOR=nano
...
# added by travis gem
[ -f /home/dailenei/.travis/travis.sh ] && source /home/dailenei/.travis/travis.sh
